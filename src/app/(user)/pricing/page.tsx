    ...
    <div className=" bg-fintown-bg dark:bg-fintown-bg-light font-inter custom-scrollbar">
      ...
      <main className="ml-[75px] mx-4 my-16">
        <div className="text-center mt-48" >
            <h1 className="text-4xl leading-9 mb-2 font-semibold text-fintown-txt-1 dark:text-fintown-txt-1-light">Hãy trân trọng</h1>
        </div>
        <div className="text-center mt-10">
            ...
            <div className="max-w-[684px] mx-auto">
                <span className="font-inter font-normal text-fintown-txt-1 dark:text-fintown-txt-1-light text-center md:text-[1.125rem] md:leading-[1.875rem] text-sm leading-5 block">
                    Hơn <span className="text-fintown-txt-1 dark:text-fintown-txt-1-light font-inter text-base leading-[1.625rem] font-bold inline">150,000+</span> nhà đầu tư chuyên nghiệp đang sử dụng <strong  className="text-[#25B770]">fintown</strong> làm công cụ
