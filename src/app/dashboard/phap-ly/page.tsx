        ...
        <div className="bg-[#181A20] text-white font-sans leading-relaxed text-[18px] min-h-screen flex items-center justify-center">
            <main className="w-full max-w-7xl bg-[#181A20] p-10 shadow-md rounded-md">
                ...
                <ul className="pl-5 list-disc text-justify">
                    <li>Không sử dụng nội dung trên trang cho mục đích phi pháp hoặc vi phạm pháp luật.</li>
                    <li>Không sao chép, phân phối hoặc sử dụng nội dung mà không có sự đồng ý bằng văn bản từ Fintown.</li>
                ...
                <ul className="pl-5 list-disc text-justify">
                    <li>Thông tin cá nhân sẽ chỉ được thu thập khi có sự đồng ý của bạn.</li>
                    <li>Dữ liệu thu thập sẽ chỉ được sử dụng để cung cấp và cải thiện dịch vụ.</li>
                ...
                <p className="text-justify">
                    Người dùng cần đảm bảo rằng họ hiểu và tuân thủ mọi quy định pháp luật có liên quan khi sử dụng trang web. Bất kỳ hành động vi phạm nào, bao gồm nhưng không giới hạn ở việc sử dụng trang web cho các hoạt động phi pháp, vi phạm quyền sở hữu trí tuệ, hoặc gây hại cho người khác, đều có thể dẫn đến việc chúng tôi tạm ngưng hoặc chấm dứt quyền truy cập của bạn vào trang web mà không cần thông báo trước.
                </p>
                ...
                <p className="text-justify">
                    Người dùng không được sao chép, chỉnh sửa, phân phối hoặc sử dụng bất kỳ nội dung nào từ trang web mà không có sự cho phép bằng văn bản từ chúng tôi. Các yêu cầu sử dụng nội dung nên được gửi tới bộ phận pháp lý của Fintown để xem xét và phê duyệt.
                </p>
                <p className="text-justify">
                ...
                <p className="text-justify">
                    Người dùng có trách nhiệm kiểm tra các thay đổi này thường xuyên để đảm bảo rằng họ hiểu và tuân thủ các điều khoản mới nhất. Việc tiếp tục sử dụng trang web sau khi các thay đổi có hiệu lực đồng nghĩa với việc bạn chấp nhận các điều khoản và điều kiện mới.
                </p>
                <p className="text-justify">
                    Nếu có bất kỳ phần nào của các điều khoản và điều kiện bị vô hiệu hoặc không thể thực thi theo luật pháp hiện hành, phần đó sẽ được sửa đổi hoặc loại bỏ mà không ảnh hưởng đến tính hiệu lực của các phần còn lại.
                </p>
            </main>
        </div>
    );
